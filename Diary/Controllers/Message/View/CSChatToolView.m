...
@interface CSChatToolView ()<UITextViewDelegate, AVAudioRecorderDelegate, AVAudioPlayerDelegate,FaceBoardDelegate,ChatAssistanceViewDelegate>
...
- (instancetype)initWithObserver:(NSObject<CSChatToolViewKeyboardProtcol> *)object andViewController:(UIViewController *)viewController{
    self = [super init];
    if (self) {
        if (object) {
              _observer = object;
...
- (void)initInputView{
    ...
    [_moreItemBtn setImage:[UIImage imageNamed:@"bg_kanzhe_xuanze"] forState:UIControlStateNormal];
  ...
  //  _contentBackground.image = [UIImage imageNamed:@"Action_Sheet_Normal_New"];
    ...
    _faceBoard = [[FaceBoard alloc] initWithFrame:CGRectMake(0, Screen_height, Screen_Width, KASSIGANTVIEW_HEIGHT)];
    _faceBoard.FaceDelegate = self;
    _assistanceView = [[ChatAssistanceView alloc] initWithFrame:CGRectMake(0, Screen_height, Screen_Width, KASSIGANTVIEW_HEIGHT)];
    _assistanceView.currentVc = _viewController;
...
- (void)messageAction:(UIButton *)sender{
    if (sender.selected) {
        ...
        [UIView animateWithDuration:0.25 animations:^{
            self.frame = CGRectMake(0, Screen_height - KINPUTVIEW_HEIGHT - NavigationBarHeight, _hiddenKeyboardRect.size.width, _hiddenKeyboardRect.size.height);
        }];
        //未选中状态事件
    }
...
- (void)moreItemAction:(UIButton *)sender{
    if (sender.selected) {
        ...
        [UIView animateWithDuration:0.25 animations:^{
            [_assistanceView setFrame:CGRectMake(0, Screen_height, Screen_Width, KASSIGANTVIEW_HEIGHT)];
        ...
        [UIView animateWithDuration:0.25 animations:^{
            self.frame = CGRectMake(0, Screen_height - KASSIGANTVIEW_HEIGHT - KINPUTVIEW_HEIGHT - NavigationBarHeight, _hiddenKeyboardRect.size.width, _hiddenKeyboardRect.size.height);
            
        }];
        [UIView animateWithDuration:0.25 animations:^{
            [_assistanceView setFrame:CGRectMake(0, KINPUTVIEW_HEIGHT, Screen_Width, KASSIGANTVIEW_HEIGHT)];
...
- (void)emojiAction:(UIButton *)sender{
    if (sender.selected) {
        ...
        [UIView animateWithDuration:0.25 animations:^{
            [_faceBoard setFrame:CGRectMake(0, Screen_height, Screen_Width, KASSIGANTVIEW_HEIGHT)];
        ...
        [UIView animateWithDuration:0.25 animations:^{
            [_faceBoard setFrame:CGRectMake(0, KINPUTVIEW_HEIGHT, Screen_Width, KASSIGANTVIEW_HEIGHT)];
