...
#import "SPUtil.h"
#import <WXOpenIMSDKFMWK/IYWContactService.h>
...
- (void)initializeAppearance
{
    ...
    [self.privateContentView addSubview:_messageLabel];
    ...
    [self.privateContentView addSubview:grayLabel];
...
- (void)bindConversation:(id )conversation{
    YWConversation * sation = conversation;
    _timeLabel.text = [NSDate daySinceDate:sation.conversationLatestMessageTime];
    _messageLabel.text = sation.conversationLatestMessageContent;
