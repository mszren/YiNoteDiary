...
- (void)viewDidLoad
{
    ...
    [[BaseNavigation sharedInstance] setGreenNavigationBar:self andTitle: NSLocalizedString(@"位置信息", nil)];
    ...
    if (_isSendLocation) {
        ...
        [sendButton setTitleColor:BGViewColor forState:UIControlStateNormal];
...
- (void)startLocation
{
    ...
    [self showHudInView:self.view hint:NSLocalizedString(@"正在定位", nil)];
}
